...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <!--li><i class="fa fa-list"></i><a href="ui-badges.html">Listar</a></li-->
    ...
    <!--- Editor Text Html ckeditor-->
    <!--script src=" {{ URL::asset('vendor/ckeditor/ckeditor.js') }}"></script-->
    <script src=" {{ URL::asset('vendor/ckeditor5-build-classic/ckeditor.js') }}"></script>
